...
for d in {1..10}; do
    ...
    ./gen_leda_geo_sweep_intersection_time 2000 30 5 > testsets/leda_geo_sweep_intersection_time_d${d}_N2000_k30_s5.csv
    python3 ../number_converter.py --file testsets/leda_geo_sweep_intersection_time_d${d}_N2000_k30_s5.csv --output testsets-binary/leda_geo_sweep_intersection_time_d${d}_N2000_k30_s5.csv
done
