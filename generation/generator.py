...
def main():
    configurations = [
        ...
        (random_int, (1000, 10000), "random_int_s_1000.csv"),
        # (random_int, (1500, 10000), "random_int_s_1500.csv"),
        (random_int, (2000, 10000), "random_int_s_2000.csv"),
        # (random_int, (2500, 10000), "random_int_s_2500.csv"),
        (random_int, (3000, 10000), "random_int_s_3000.csv"),
        # (random_int, (3500, 10000), "random_int_s_3500.csv"),
        (random_int, (4000, 10000), "random_int_s_4000.csv"),
        # (random_int, (4500, 10000), "random_int_s_4500.csv"),
        (random_int, (5000, 10000), "random_int_s_5000.csv"),
        ...
        (random_int, (1000, 1234567890), "random_int_m_1000.csv"),
        # (random_int, (1500, 1234567890), "random_int_m_1500.csv"),
        (random_int, (2000, 1234567890), "random_int_m_2000.csv"),
        # (random_int, (2500, 1234567890), "random_int_m_2500.csv"),
        (random_int, (3000, 1234567890), "random_int_m_3000.csv"),
        # (random_int, (3500, 1234567890), "random_int_m_3500.csv"),
        (random_int, (4000, 1234567890), "random_int_m_4000.csv"),
        # (random_int, (4500, 1234567890), "random_int_m_4500.csv"),
        (random_int, (5000, 1234567890), "random_int_m_5000.csv"),
        ...
        (random_int, (1000, 12345678901234567890), "random_int_l_1000.csv"),
        # (random_int, (1500, 12345678901234567890), "random_int_l_1500.csv"),
        (random_int, (2000, 12345678901234567890), "random_int_l_2000.csv"),
        # (random_int, (2500, 12345678901234567890), "random_int_l_2500.csv"),
        (random_int, (3000, 12345678901234567890), "random_int_l_3000.csv"),
        # (random_int, (3500, 12345678901234567890), "random_int_l_3500.csv"),
        (random_int, (4000, 12345678901234567890), "random_int_l_4000.csv"),
        # (random_int, (4500, 12345678901234567890), "random_int_l_4500.csv"),
        (random_int, (5000, 12345678901234567890), "random_int_l_5000.csv"),
        ...
        #(rounding, (500, 10000, 10000), "rounding_s_500.csv"),
        (rounding_y, (1000, 10000, 10000), "rounding_y_s_1000.csv"),
        #(rounding, (1500, 10000, 10000), "rounding_s_1500.csv"),
        (rounding_y, (2000, 10000, 10000), "rounding_y_s_2000.csv"),
        #(rounding, (2500, 10000, 10000), "rounding_s_2500.csv"),
        (rounding_y, (3000, 10000, 10000), "rounding_y_s_3000.csv"),
        #(rounding, (3500, 10000, 10000), "rounding_s_3500.csv"),
        (rounding_y, (4000, 10000, 10000), "rounding_y_s_4000.csv"),
        #(rounding, (4500, 10000, 10000), "rounding_s_4500.csv"),
        (rounding_y, (5000, 10000, 10000), "rounding_y_s_5000.csv"),
        ...
        #(rounding, (500, 1234567890, 10000), "rounding_m_500.csv"),
        (rounding_y, (1000, 1234567890, 10000), "rounding_y_m_1000.csv"),
        #(rounding, (1500, 1234567890, 10000), "rounding_m_1500.csv"),
        (rounding_y, (2000, 1234567890, 10000), "rounding_y_m_2000.csv"),
        #(rounding, (2500, 1234567890, 10000), "rounding_m_2500.csv"),
        (rounding_y, (3000, 1234567890, 10000), "rounding_y_m_3000.csv"),
        #(rounding, (3500, 1234567890, 10000), "rounding_m_3500.csv"),
        (rounding_y, (4000, 1234567890, 10000), "rounding_y_m_4000.csv"),
        #(rounding, (4500, 1234567890, 10000), "rounding_m_4500.csv"),
        (rounding_y, (5000, 1234567890, 10000), "rounding_y_m_5000.csv"),
        ...
        #(rounding, (500, 12345678901234567890, 10000), "rounding_l_500.csv"),
        (rounding_y, (1000, 12345678901234567890, 10000), "rounding_y_l_1000.csv"),
        #(rounding, (1500, 12345678901234567890, 10000), "rounding_l_1500.csv"),
        (rounding_y, (2000, 12345678901234567890, 10000), "rounding_y_l_2000.csv"),
        #(rounding, (2500, 12345678901234567890, 10000), "rounding_l_2500.csv"),
        (rounding_y, (3000, 12345678901234567890, 10000), "rounding_y_l_3000.csv"),
        #(rounding, (3500, 12345678901234567890, 10000), "rounding_l_3500.csv"),
        (rounding_y, (4000, 12345678901234567890, 10000), "rounding_y_l_4000.csv"),
        #(rounding, (4500, 12345678901234567890, 10000), "rounding_l_4500.csv"),
        (rounding_y, (5000, 12345678901234567890, 10000), "rounding_y_l_5000.csv"),
        ...
        (star_intersections_11, (1000, 10000), "star_intersections_11_s_1000.csv"),
        # (star_intersections_11, (1500, 10000), "star_intersections_11_s_1500.csv"),
        (star_intersections_11, (2000, 10000), "star_intersections_11_s_2000.csv"),
        # (star_intersections_11, (2500, 10000), "star_intersections_11_s_2500.csv"),
        (star_intersections_11, (3000, 10000), "star_intersections_11_s_3000.csv"),
        # (star_intersections_11, (3500, 10000), "star_intersections_11_s_3500.csv"),
        (star_intersections_11, (4000, 10000), "star_intersections_11_s_4000.csv"),
        # (star_intersections_11, (4500, 10000), "star_intersections_11_s_4500.csv"),
        (star_intersections_11, (5000, 10000), "star_intersections_11_s_5000.csv"),
        ...
        (star_intersections_11, (1000, 1234567890), "star_intersections_11_m_1000.csv"),
        # (star_intersections_11, (1500, 1234567890), "star_intersections_11_m_1500.csv"),
        (star_intersections_11, (2000, 1234567890), "star_intersections_11_m_2000.csv"),
        # (star_intersections_11, (2500, 1234567890), "star_intersections_11_m_2500.csv"),
        (star_intersections_11, (3000, 1234567890), "star_intersections_11_m_3000.csv"),
        # (star_intersections_11, (3500, 1234567890), "star_intersections_11_m_3500.csv"),
        (star_intersections_11, (4000, 1234567890), "star_intersections_11_m_4000.csv"),
        # (star_intersections_11, (4500, 1234567890), "star_intersections_11_m_4500.csv"),
        (star_intersections_11, (5000, 1234567890), "star_intersections_11_m_5000.csv"),
        ...
        (star_intersections_11, (1000, 12345678901234567890), "star_intersections_11_l_1000.csv"),
        # (star_intersections_11, (1500, 12345678901234567890), "star_intersections_11_l_1500.csv"),
        (star_intersections_11, (2000, 12345678901234567890), "star_intersections_11_l_2000.csv"),
        # (star_intersections_11, (2500, 12345678901234567890), "star_intersections_11_l_2500.csv"),
        (star_intersections_11, (3000, 12345678901234567890), "star_intersections_11_l_3000.csv"),
        # (star_intersections_11, (3500, 12345678901234567890), "star_intersections_11_l_3500.csv"),
        (star_intersections_11, (4000, 12345678901234567890), "star_intersections_11_l_4000.csv"),
        # (star_intersections_11, (4500, 12345678901234567890), "star_intersections_11_l_4500.csv"),
        (star_intersections_11, (5000, 12345678901234567890), "star_intersections_11_l_5000.csv"),
