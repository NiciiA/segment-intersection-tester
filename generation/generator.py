...
"""
    TODO: generate into subfolders per group
"""
...
def random_int(num_segments, max_coord):
    return [generate_random_segment_int(max_coord) for _ in range(num_segments)]
...
def save_segments_to_csv(segments, filename="segments.csv", folder=""):
    os.makedirs('tests', exist_ok=True)
    os.makedirs('tests/' + folder, exist_ok=True)
    filepath = os.path.join('tests', folder, filename)
...
def save_accuracy_to_csv(accuracies_d, accuracies_r, filename="accuracy.csv", folder=""):
    os.makedirs('tests/' + folder + '/accuracies', exist_ok=True)
    filepath_d = os.path.join('tests', folder, 'accuracies', "d_" + filename)
    filepath_r = os.path.join('tests', folder, 'accuracies', "r_" + filename)
...
def process_configuration(func, params, filename, folder):
    filepath = os.path.join('tests', folder, filename)
    ...
    save_segments_to_csv(segments, filename, folder)
    ...
    if filename.startswith(("accuracy_", "rounding_", "star_intersections_7_", "star_intersections_8_")): # "parallel_", "length_", "star_",
        ...
        save_accuracy_to_csv(intersections_d, intersections_r, filename, folder)
...
def main():
    configurations = [
        (parallel_and_collinear_1, (), "parallel_and_collinear_1.csv", "parallel_and_collinear"),
        (parallel_and_collinear_2, (), "parallel_and_collinear_2.csv", "parallel_and_collinear"),
        (parallel_and_collinear_3, (), "parallel_and_collinear_3.csv", "parallel_and_collinear"),
        (parallel_and_collinear_4, (), "parallel_and_collinear_4.csv", "parallel_and_collinear"),
        (parallel_and_collinear_5, (), "parallel_and_collinear_5.csv", "parallel_and_collinear"),
        (parallel_and_collinear_6, (), "parallel_and_collinear_6.csv", "parallel_and_collinear"),
        (parallel_and_collinear_7, (), "parallel_and_collinear_7.csv", "parallel_and_collinear"),
        (parallel_and_collinear_8, (), "parallel_and_collinear_8.csv", "parallel_and_collinear"),
        (parallel_and_collinear_9, (), "parallel_and_collinear_9.csv", "parallel_and_collinear"),
        (parallel_and_collinear_10, (), "parallel_and_collinear_10.csv", "parallel_and_collinear"),
        (parallel_and_collinear_11, (), "parallel_and_collinear_11.csv", "parallel_and_collinear"),
        (parallel_and_collinear_12, (), "parallel_and_collinear_12.csv", "parallel_and_collinear"),
        (parallel_and_collinear_13, (), "parallel_and_collinear_13.csv", "parallel_and_collinear"),
        (parallel_and_collinear_14, (), "parallel_and_collinear_14.csv", "parallel_and_collinear"),
        (parallel_and_collinear_15, (), "parallel_and_collinear_15.csv", "parallel_and_collinear"),
        (parallel_and_collinear_16, (), "parallel_and_collinear_16.csv", "parallel_and_collinear"),
        (parallel_and_collinear_17, (), "parallel_and_collinear_17.csv", "parallel_and_collinear"),
        (parallel_and_collinear_18, (), "parallel_and_collinear_18.csv", "parallel_and_collinear"),
        (parallel_and_collinear_19, (), "parallel_and_collinear_19.csv", "parallel_and_collinear"),
        (parallel_and_collinear_20, (), "parallel_and_collinear_20.csv", "parallel_and_collinear"),
        (length_0_1, (), "length_0_1.csv", "length_0"),
        (length_0_2, (), "length_0_2.csv", "length_0"),
        (length_0_3, (), "length_0_3.csv", "length_0"),
        (length_0_4, (), "length_0_4.csv", "length_0"),
        (multi_axis_1, (), "multi_axis_1.csv", "multi_axis"),
        (multi_axis_2, (), "multi_axis_2.csv", "multi_axis"),
        (multi_axis_3, (), "multi_axis_3.csv", "multi_axis"),
        (multi_axis_4, (), "multi_axis_4.csv", "multi_axis"),
        (multi_axis_5, (), "multi_axis_5.csv", "multi_axis"),
        (multi_axis_6, (), "multi_axis_6.csv", "multi_axis"),
        (multi_axis_7, (), "multi_axis_7.csv", "multi_axis"),
        (multi_axis_8, (), "multi_axis_8.csv", "multi_axis"),
        (star_intersections_1, (), "star_intersections_1.csv", "star_intersections"),
        (star_intersections_2, (), "star_intersections_2.csv", "star_intersections"),
        (star_intersections_3, (), "star_intersections_3.csv", "star_intersections"),
        (star_intersections_5, (), "star_intersections_5.csv", "star_intersections"),
        (accuracy_1, (), "accuracy_1.csv", "accuracy"),
        (accuracy_2, (), "accuracy_2.csv", "accuracy"),
        (accuracy_3, (), "accuracy_3.csv", "accuracy"),
        (accuracy_4, (), "accuracy_4.csv", "accuracy"),
        (accuracy_5, (), "accuracy_5.csv", "accuracy"),
        (accuracy_6, (), "accuracy_6.csv", "accuracy"),
        (accuracy_7, (), "accuracy_7.csv", "accuracy"),
        (accuracy_8, (), "accuracy_8.csv", "accuracy"),
        (accuracy_9, (), "accuracy_9.csv", "accuracy"),
        (accuracy_10, (), "accuracy_10.csv", "accuracy"),
        # Special star_intersections_4 with extra arguments
        #(star_intersections_4, (500, 10000), "star_intersections_4_s_500.csv"),
        (star_intersections_4, (1000, 10000), "star_intersections_4_s_1000.csv", "star_intersections"),
        #(star_intersections_4, (1500, 10000), "star_intersections_4_s_1500.csv"),
        (star_intersections_4, (2000, 10000), "star_intersections_4_s_2000.csv", "star_intersections"),
        #(star_intersections_4, (2500, 10000), "star_intersections_4_s_2500.csv"),
        (star_intersections_4, (3000, 10000), "star_intersections_4_s_3000.csv", "star_intersections"),
        #(star_intersections_4, (3500, 10000), "star_intersections_4_s_3500.csv"),
        (star_intersections_4, (4000, 10000), "star_intersections_4_s_4000.csv", "star_intersections"),
        #(star_intersections_4, (4500, 10000), "star_intersections_4_s_4500.csv"),
        (star_intersections_4, (5000, 10000), "star_intersections_4_s_5000.csv", "star_intersections"),
        ...
        (star_intersections_6, (1000, 10000), "star_intersections_6_s_1000.csv", "star_intersections"),
        #(star_intersections_6, (1500, 10000), "star_intersections_6_s_1500.csv"),
        (star_intersections_6, (2000, 10000), "star_intersections_6_s_2000.csv", "star_intersections"),
        #(star_intersections_6, (2500, 10000), "star_intersections_6_s_2500.csv"),
        (star_intersections_6, (3000, 10000), "star_intersections_6_s_3000.csv", "star_intersections"),
        #(star_intersections_6, (3500, 10000), "star_intersections_6_s_3500.csv"),
        (star_intersections_6, (4000, 10000), "star_intersections_6_s_4000.csv", "star_intersections"),
        #(star_intersections_6, (4500, 10000), "star_intersections_6_s_4500.csv"),
        (star_intersections_6, (5000, 10000), "star_intersections_6_s_5000.csv", "star_intersections"),
        ...
        (star_intersections_7, (1000, 10000), "star_intersections_7_s_1000.csv", "star_intersections"),
        #(star_intersections_7, (1500, 10000), "star_intersections_7_s_1500.csv"),
        (star_intersections_7, (2000, 10000), "star_intersections_7_s_2000.csv", "star_intersections"),
        #(star_intersections_7, (2500, 10000), "star_intersections_7_s_2500.csv"),
        (star_intersections_7, (3000, 10000), "star_intersections_7_s_3000.csv", "star_intersections"),
        #(star_intersections_7, (3500, 10000), "star_intersections_7_s_3500.csv"),
        (star_intersections_7, (4000, 10000), "star_intersections_7_s_4000.csv", "star_intersections"),
        #(star_intersections_7, (4500, 10000), "star_intersections_7_s_4500.csv"),
        (star_intersections_7, (5000, 10000), "star_intersections_7_s_5000.csv", "star_intersections"),
        ...
        (star_intersections_8, (1000, 10000), "star_intersections_8_s_1000.csv", "star_intersections"),
        #(star_intersections_8, (1500, 10000), "star_intersections_8_s_1500.csv"),
        (star_intersections_8, (2000, 10000), "star_intersections_8_s_2000.csv", "star_intersections"),
        #(star_intersections_8, (2500, 10000), "star_intersections_8_s_2500.csv"),
        (star_intersections_8, (3000, 10000), "star_intersections_8_s_3000.csv", "star_intersections"),
        #(star_intersections_8, (3500, 10000), "star_intersections_8_s_3500.csv"),
        (star_intersections_8, (4000, 10000), "star_intersections_8_s_4000.csv", "star_intersections"),
        #(star_intersections_8, (4500, 10000), "star_intersections_8_s_4500.csv"),
        (star_intersections_8, (5000, 10000), "star_intersections_8_s_5000.csv", "star_intersections"),
        ...
        (star_intersections_4, (1000, 1234567890), "star_intersections_4_m_1000.csv", "star_intersections"),
        #(star_intersections_4, (1500, 1234567890), "star_intersections_4_m_1500.csv"),
        (star_intersections_4, (2000, 1234567890), "star_intersections_4_m_2000.csv", "star_intersections"),
        #(star_intersections_4, (2500, 1234567890), "star_intersections_4_m_2500.csv"),
        (star_intersections_4, (3000, 1234567890), "star_intersections_4_m_3000.csv", "star_intersections"),
        #(star_intersections_4, (3500, 1234567890), "star_intersections_4_m_3500.csv"),
        (star_intersections_4, (4000, 1234567890), "star_intersections_4_m_4000.csv", "star_intersections"),
        #(star_intersections_4, (4500, 1234567890), "star_intersections_4_m_4500.csv"),
        (star_intersections_4, (5000, 1234567890), "star_intersections_4_m_5000.csv", "star_intersections"),
        ...
        (star_intersections_6, (1000, 1234567890), "star_intersections_6_m_1000.csv", "star_intersections"),
        #(star_intersections_6, (1500, 1234567890), "star_intersections_6_m_1500.csv"),
        (star_intersections_6, (2000, 1234567890), "star_intersections_6_m_2000.csv", "star_intersections"),
        #(star_intersections_6, (2500, 1234567890), "star_intersections_6_m_2500.csv"),
        (star_intersections_6, (3000, 1234567890), "star_intersections_6_m_3000.csv", "star_intersections"),
        #(star_intersections_6, (3500, 1234567890), "star_intersections_6_m_3500.csv"),
        (star_intersections_6, (4000, 1234567890), "star_intersections_6_m_4000.csv", "star_intersections"),
        #(star_intersections_6, (4500, 1234567890), "star_intersections_6_m_4500.csv"),
        (star_intersections_6, (5000, 1234567890), "star_intersections_6_m_5000.csv", "star_intersections"),
        ...
        (star_intersections_7, (1000, 1234567890), "star_intersections_7_m_1000.csv", "star_intersections"),
        #(star_intersections_7, (1500, 1234567890), "star_intersections_7_m_1500.csv"),
        (star_intersections_7, (2000, 1234567890), "star_intersections_7_m_2000.csv", "star_intersections"),
        #(star_intersections_7, (2500, 1234567890), "star_intersections_7_m_2500.csv"),
        (star_intersections_7, (3000, 1234567890), "star_intersections_7_m_3000.csv", "star_intersections"),
        #(star_intersections_7, (3500, 1234567890), "star_intersections_7_m_3500.csv"),
        (star_intersections_7, (4000, 1234567890), "star_intersections_7_m_4000.csv", "star_intersections"),
        #(star_intersections_7, (4500, 1234567890), "star_intersections_7_m_4500.csv"),
        (star_intersections_7, (5000, 1234567890), "star_intersections_7_m_5000.csv", "star_intersections"),
        ...
        (star_intersections_8, (1000, 1234567890), "star_intersections_8_m_1000.csv", "star_intersections"),
        #(star_intersections_8, (1500, 1234567890), "star_intersections_8_m_1500.csv"),
        (star_intersections_8, (2000, 1234567890), "star_intersections_8_m_2000.csv", "star_intersections"),
        #(star_intersections_8, (2500, 1234567890), "star_intersections_8_m_2500.csv"),
        (star_intersections_8, (3000, 1234567890), "star_intersections_8_m_3000.csv", "star_intersections"),
        #(star_intersections_8, (3500, 1234567890), "star_intersections_8_m_3500.csv"),
        (star_intersections_8, (4000, 1234567890), "star_intersections_8_m_4000.csv", "star_intersections"),
        #(star_intersections_8, (4500, 1234567890), "star_intersections_8_m_4500.csv"),
        (star_intersections_8, (5000, 1234567890), "star_intersections_8_m_5000.csv", "star_intersections"),
        ...
        (star_intersections_4, (1000, 12345678901234567890), "star_intersections_4_l_1000.csv", "star_intersections"),
        #(star_intersections_4, (1500, 12345678901234567890), "star_intersections_4_l_1500.csv"),
        (star_intersections_4, (2000, 12345678901234567890), "star_intersections_4_l_2000.csv", "star_intersections"),
        #(star_intersections_4, (2500, 12345678901234567890), "star_intersections_4_l_2500.csv"),
        (star_intersections_4, (3000, 12345678901234567890), "star_intersections_4_l_3000.csv", "star_intersections"),
        #(star_intersections_4, (3500, 12345678901234567890), "star_intersections_4_l_3500.csv"),
        (star_intersections_4, (4000, 12345678901234567890), "star_intersections_4_l_4000.csv", "star_intersections"),
        #(star_intersections_4, (4500, 12345678901234567890), "star_intersections_4_l_4500.csv"),
        (star_intersections_4, (5000, 12345678901234567890), "star_intersections_4_l_5000.csv", "star_intersections"),
        ...
        (star_intersections_6, (1000, 12345678901234567890), "star_intersections_6_l_1000.csv", "star_intersections"),
        #(star_intersections_6, (1500, 12345678901234567890), "star_intersections_6_l_1500.csv"),
        (star_intersections_6, (2000, 12345678901234567890), "star_intersections_6_l_2000.csv", "star_intersections"),
        #(star_intersections_6, (2500, 12345678901234567890), "star_intersections_6_l_2500.csv"),
        (star_intersections_6, (3000, 12345678901234567890), "star_intersections_6_l_3000.csv", "star_intersections"),
        #(star_intersections_6, (3500, 12345678901234567890), "star_intersections_6_l_3500.csv"),
        (star_intersections_6, (4000, 12345678901234567890), "star_intersections_6_l_4000.csv", "star_intersections"),
        #(star_intersections_6, (4500, 12345678901234567890), "star_intersections_6_l_4500.csv"),
        (star_intersections_6, (5000, 12345678901234567890), "star_intersections_6_l_5000.csv", "star_intersections"),
        ...
        (star_intersections_7, (1000, 12345678901234567890), "star_intersections_7_l_1000.csv", "star_intersections"),
        #(star_intersections_7, (1500, 12345678901234567890), "star_intersections_7_l_1500.csv"),
        (star_intersections_7, (2000, 12345678901234567890), "star_intersections_7_l_2000.csv", "star_intersections"),
        #(star_intersections_7, (2500, 12345678901234567890), "star_intersections_7_l_2500.csv"),
        (star_intersections_7, (3000, 12345678901234567890), "star_intersections_7_l_3000.csv", "star_intersections"),
        #(star_intersections_7, (3500, 12345678901234567890), "star_intersections_7_l_3500.csv"),
        (star_intersections_7, (4000, 12345678901234567890), "star_intersections_7_l_4000.csv", "star_intersections"),
        #(star_intersections_7, (4500, 12345678901234567890), "star_intersections_7_l_4500.csv"),
        (star_intersections_7, (5000, 12345678901234567890), "star_intersections_7_l_5000.csv", "star_intersections"),
        ...
        (star_intersections_8, (1000, 12345678901234567890), "star_intersections_8_l_1000.csv", "star_intersections"),
        #(star_intersections_8, (1500, 12345678901234567890), "star_intersections_8_l_1500.csv"),
        (star_intersections_8, (2000, 12345678901234567890), "star_intersections_8_l_2000.csv", "star_intersections"),
        #(star_intersections_8, (2500, 12345678901234567890), "star_intersections_8_l_2500.csv"),
        (star_intersections_8, (3000, 12345678901234567890), "star_intersections_8_l_3000.csv", "star_intersections"),
        #(star_intersections_8, (3500, 12345678901234567890), "star_intersections_8_l_3500.csv"),
        (star_intersections_8, (4000, 12345678901234567890), "star_intersections_8_l_4000.csv", "star_intersections"),
        #(star_intersections_8, (4500, 12345678901234567890), "star_intersections_8_l_4500.csv"),
        (star_intersections_8, (5000, 12345678901234567890), "star_intersections_8_l_5000.csv", "star_intersections"),
        ...
        (random_x, (1000, 10000), "random_s_1000.csv", "random"),
        # (random_x, (1500, 10000), "random_s_1500.csv"),
        (random_x, (2000, 10000), "random_s_2000.csv", "random"),
        # (random_x, (2500, 10000), "random_s_2500.csv"),
        (random_x, (3000, 10000), "random_s_3000.csv", "random"),
        # (random_x, (3500, 10000), "random_s_3500.csv"),
        (random_x, (4000, 10000), "random_s_4000.csv", "random"),
        # (random_x, (4500, 10000), "random_s_4500.csv"),
        (random_x, (5000, 10000), "random_s_5000.csv", "random"),
        ...
        (random_x, (1000, 1234567890), "random_m_1000.csv", "random"),
        # (random_x, (1500, 1234567890), "random_m_1500.csv"),
        (random_x, (2000, 1234567890), "random_m_2000.csv", "random"),
        # (random_x, (2500, 1234567890), "random_m_2500.csv"),
        (random_x, (3000, 1234567890), "random_m_3000.csv", "random"),
        # (random_x, (3500, 1234567890), "random_m_3500.csv"),
        (random_x, (4000, 1234567890), "random_m_4000.csv", "random"),
        # (random_x, (4500, 1234567890), "random_m_4500.csv"),
        (random_x, (5000, 1234567890), "random_m_5000.csv", "random"),
        ...
        (random_x, (1000, 12345678901234567890), "random_l_1000.csv", "random"),
        # (random_x, (1500, 12345678901234567890), "random_l_1500.csv"),
        (random_x, (2000, 12345678901234567890), "random_l_2000.csv", "random"),
        # (random_x, (2500, 12345678901234567890), "random_l_2500.csv"),
        (random_x, (3000, 12345678901234567890), "random_l_3000.csv", "random"),
        # (random_x, (3500, 12345678901234567890), "random_l_3500.csv"),
        (random_x, (4000, 12345678901234567890), "random_l_4000.csv", "random"),
        # (random_x, (4500, 12345678901234567890), "random_l_4500.csv"),
        (random_x, (5000, 12345678901234567890), "random_l_5000.csv", "random"),
        ...
        # random_int calls
        # (random_int, (500, 10000), "random_int_s_500.csv"),
        (random_int, (1000, 10000), "random_int_s_1000.csv", "random"),
        # (random_int, (1500, 10000), "random_int_s_1500.csv"),
        (random_int, (2000, 10000), "random_int_s_2000.csv", "random"),
        # (random_int, (2500, 10000), "random_int_s_2500.csv"),
        (random_int, (3000, 10000), "random_int_s_3000.csv", "random"),
        # (random_int, (3500, 10000), "random_int_s_3500.csv"),
        (random_int, (4000, 10000), "random_int_s_4000.csv", "random"),
        # (random_int, (4500, 10000), "random_int_s_4500.csv"),
        (random_int, (5000, 10000), "random_int_s_5000.csv", "random"),
        # (random_int, (5500, 10000), "random_int_s_5500.csv"),
        # (random_int, (6000, 10000), "random_int_s_6000.csv"),
        # (random_int, (6500, 10000), "random_int_s_6500.csv"),
        # (random_int, (7000, 10000), "random_int_s_7000.csv"),
        # (random_int, (7500, 10000), "random_int_s_7500.csv"),
        # (random_int, (8000, 10000), "random_int_s_8000.csv"),
        # (random_int, (8500, 10000), "random_int_s_8500.csv"),
        # (random_int, (9000, 10000), "random_int_s_9000.csv"),
        # (random_int, (9500, 10000), "random_int_s_9500.csv"),
        # (random_int, (10000, 10000), "random_int_s_10000.csv"),

        # (random_int, (500, 1234567890), "random_int_m_500.csv"),
        (random_int, (1000, 1234567890), "random_int_m_1000.csv", "random"),
        # (random_int, (1500, 1234567890), "random_int_m_1500.csv"),
        (random_int, (2000, 1234567890), "random_int_m_2000.csv", "random"),
        # (random_int, (2500, 1234567890), "random_int_m_2500.csv"),
        (random_int, (3000, 1234567890), "random_int_m_3000.csv", "random"),
        # (random_int, (3500, 1234567890), "random_int_m_3500.csv"),
        (random_int, (4000, 1234567890), "random_int_m_4000.csv", "random"),
        # (random_int, (4500, 1234567890), "random_int_m_4500.csv"),
        (random_int, (5000, 1234567890), "random_int_m_5000.csv", "random"),
        # (random_int, (5500, 1234567890), "random_int_m_5500.csv"),
        # (random_int, (6000, 1234567890), "random_int_m_6000.csv"),
        # (random_int, (6500, 1234567890), "random_int_m_6500.csv"),
        # (random_int, (7000, 1234567890), "random_int_m_7000.csv"),
        # (random_int, (7500, 1234567890), "random_int_m_7500.csv"),
        # (random_int, (8000, 1234567890), "random_int_m_8000.csv"),
        # (random_int, (8500, 1234567890), "random_int_m_8500.csv"),
        # (random_int, (9000, 1234567890), "random_int_m_9000.csv"),
        # (random_int, (9500, 1234567890), "random_int_m_9500.csv"),
        # (random_int, (10000, 1234567890), "random_int_m_10000.csv"),

        # (random_int, (500, 12345678901234567890), "random_int_l_500.csv"),
        (random_int, (1000, 12345678901234567890), "random_int_l_1000.csv", "random"),
        # (random_int, (1500, 12345678901234567890), "random_int_l_1500.csv"),
        (random_int, (2000, 12345678901234567890), "random_int_l_2000.csv", "random"),
        # (random_int, (2500, 12345678901234567890), "random_int_l_2500.csv"),
        (random_int, (3000, 12345678901234567890), "random_int_l_3000.csv", "random"),
        # (random_int, (3500, 12345678901234567890), "random_int_l_3500.csv"),
        (random_int, (4000, 12345678901234567890), "random_int_l_4000.csv", "random"),
        # (random_int, (4500, 12345678901234567890), "random_int_l_4500.csv"),
        (random_int, (5000, 12345678901234567890), "random_int_l_5000.csv", "random"),
        # (random_int, (5500, 12345678901234567890), "random_int_l_5500.csv"),
        # (random_int, (6000, 12345678901234567890), "random_int_l_6000.csv"),
        # (random_int, (6500, 12345678901234567890), "random_int_l_6500.csv"),
        # (random_int, (7000, 12345678901234567890), "random_int_l_7000.csv"),
        # (random_int, (7500, 12345678901234567890), "random_int_l_7500.csv"),
        # (random_int, (8000, 12345678901234567890), "random_int_l_8000.csv"),
        # (random_int, (8500, 12345678901234567890), "random_int_l_8500.csv"),
        # (random_int, (9000, 12345678901234567890), "random_int_l_9000.csv"),
        # (random_int, (9500, 12345678901234567890), "random_int_l_9500.csv"),
        # (random_int, (10000, 12345678901234567890), "random_int_l_10000.csv"),

        # Clustered_x calls
        # (clustered_x, (500, 5000, 1), "clustered_s_1.csv"),
        (clustered_x, (1000, 10000, 1), "clustered_m_1.csv", "clustered"),
        # (clustered_x, (1500, 15000, 1), "clustered_l_1.csv"),
        (clustered_x, (2000, 20000, 1), "clustered_xl_1.csv", "clustered"),
        # (clustered_x, (2500, 25000, 1), "clustered_xxl_1.csv"),
        (clustered_x, (3000, 30000, 1), "clustered_xxxl_1.csv", "clustered"),
        # (clustered_x, (3500, 35000, 1), "clustered_xxxxl_1.csv"),
        (clustered_x, (4000, 40000, 1), "clustered_xxxxxl_1.csv", "clustered"),
        # (clustered_x, (4500, 45000, 1), "clustered_xxxxxxl_1.csv"),
        (clustered_x, (5000, 50000, 1), "clustered_xxxxxxxl_1.csv", "clustered"),
        ...
        (clustered_x, (1000, 10000, 5), "clustered_m_5.csv", "clustered"),
        # (clustered_x, (1500, 15000, 5), "clustered_l_5.csv"),
        (clustered_x, (2000, 20000, 5), "clustered_xl_5.csv", "clustered"),
        # (clustered_x, (2500, 25000, 5), "clustered_xxl_5.csv"),
        (clustered_x, (3000, 30000, 5), "clustered_xxxl_5.csv", "clustered"),
        # (clustered_x, (3500, 35000, 5), "clustered_xxxxl_5.csv"),
        (clustered_x, (4000, 40000, 5), "clustered_xxxxxl_5.csv", "clustered"),
        # (clustered_x, (4500, 45000, 5), "clustered_xxxxxxl_5.csv"),
        (clustered_x, (5000, 50000, 5), "clustered_xxxxxxxl_5.csv", "clustered"),
        ...
        (clustered_x, (1000, 10000, 10), "clustered_m_10.csv", "clustered"),
        # (clustered_x, (1500, 15000, 10), "clustered_l_10.csv"),
        (clustered_x, (2000, 20000, 10), "clustered_xl_10.csv", "clustered"),
        # (clustered_x, (2500, 25000, 10), "clustered_xxl_10.csv"),
        (clustered_x, (3000, 30000, 10), "clustered_xxxl_10.csv", "clustered"),
        # (clustered_x, (3500, 35000, 10), "clustered_xxxxl_10.csv"),
        (clustered_x, (4000, 40000, 10), "clustered_xxxxxl_10.csv", "clustered"),
        # (clustered_x, (4500, 45000, 10), "clustered_xxxxxxl_10.csv"),
        (clustered_x, (5000, 50000, 10), "clustered_xxxxxxxl_10.csv", "clustered"),
        ...
        (rounding, (1000, 10000, 10000), "rounding_s_1000.csv", "rounding"),
        #(rounding, (1500, 10000, 10000), "rounding_s_1500.csv"),
        (rounding, (2000, 10000, 10000), "rounding_s_2000.csv", "rounding"),
        #(rounding, (2500, 10000, 10000), "rounding_s_2500.csv"),
        (rounding, (3000, 10000, 10000), "rounding_s_3000.csv", "rounding"),
        #(rounding, (3500, 10000, 10000), "rounding_s_3500.csv"),
        (rounding, (4000, 10000, 10000), "rounding_s_4000.csv", "rounding"),
        #(rounding, (4500, 10000, 10000), "rounding_s_4500.csv"),
        (rounding, (5000, 10000, 10000), "rounding_s_5000.csv", "rounding"),
        ...
        #(rounding, (500, 10000, 10000), "rounding_s_500.csv"),
        (rounding_y, (1000, 10000, 10000), "rounding_y_s_1000.csv", "rounding"),
        #(rounding, (1500, 10000, 10000), "rounding_s_1500.csv"),
        (rounding_y, (2000, 10000, 10000), "rounding_y_s_2000.csv", "rounding"),
        #(rounding, (2500, 10000, 10000), "rounding_s_2500.csv"),
        (rounding_y, (3000, 10000, 10000), "rounding_y_s_3000.csv", "rounding"),
        #(rounding, (3500, 10000, 10000), "rounding_s_3500.csv"),
        (rounding_y, (4000, 10000, 10000), "rounding_y_s_4000.csv", "rounding"),
        #(rounding, (4500, 10000, 10000), "rounding_s_4500.csv"),
        (rounding_y, (5000, 10000, 10000), "rounding_y_s_5000.csv", "rounding"),

        #(rounding, (500, 1234567890, 10000), "rounding_m_500.csv"),
        (rounding, (1000, 1234567890, 10000), "rounding_m_1000.csv", "rounding"),
        #(rounding, (1500, 1234567890, 10000), "rounding_m_1500.csv"),
        (rounding, (2000, 1234567890, 10000), "rounding_m_2000.csv", "rounding"),
        #(rounding, (2500, 1234567890, 10000), "rounding_m_2500.csv"),
        (rounding, (3000, 1234567890, 10000), "rounding_m_3000.csv", "rounding"),
        #(rounding, (3500, 1234567890, 10000), "rounding_m_3500.csv"),
        (rounding, (4000, 1234567890, 10000), "rounding_m_4000.csv", "rounding"),
        #(rounding, (4500, 1234567890, 10000), "rounding_m_4500.csv"),
        (rounding, (5000, 1234567890, 10000), "rounding_m_5000.csv", "rounding"),
        ...
        #(rounding, (500, 1234567890, 10000), "rounding_m_500.csv"),
        (rounding_y, (1000, 1234567890, 10000), "rounding_y_m_1000.csv", "rounding"),
        #(rounding, (1500, 1234567890, 10000), "rounding_m_1500.csv"),
        (rounding_y, (2000, 1234567890, 10000), "rounding_y_m_2000.csv", "rounding"),
        #(rounding, (2500, 1234567890, 10000), "rounding_m_2500.csv"),
        (rounding_y, (3000, 1234567890, 10000), "rounding_y_m_3000.csv", "rounding"),
        #(rounding, (3500, 1234567890, 10000), "rounding_m_3500.csv"),
        (rounding_y, (4000, 1234567890, 10000), "rounding_y_m_4000.csv", "rounding"),
        #(rounding, (4500, 1234567890, 10000), "rounding_m_4500.csv"),
        (rounding_y, (5000, 1234567890, 10000), "rounding_y_m_5000.csv", "rounding"),

        #(rounding, (500, 12345678901234567890, 10000), "rounding_l_500.csv"),
        (rounding, (1000, 12345678901234567890, 10000), "rounding_l_1000.csv", "rounding"),
        #(rounding, (1500, 12345678901234567890, 10000), "rounding_l_1500.csv"),
        (rounding, (2000, 12345678901234567890, 10000), "rounding_l_2000.csv", "rounding"),
        #(rounding, (2500, 12345678901234567890, 10000), "rounding_l_2500.csv"),
        (rounding, (3000, 12345678901234567890, 10000), "rounding_l_3000.csv", "rounding"),
        #(rounding, (3500, 12345678901234567890, 10000), "rounding_l_3500.csv"),
        (rounding, (4000, 12345678901234567890, 10000), "rounding_l_4000.csv", "rounding"),
        #(rounding, (4500, 12345678901234567890, 10000), "rounding_l_4500.csv"),
        (rounding, (5000, 12345678901234567890, 10000), "rounding_l_5000.csv", "rounding"),
        ...
        #(rounding, (500, 12345678901234567890, 10000), "rounding_l_500.csv"),
        (rounding_y, (1000, 12345678901234567890, 10000), "rounding_y_l_1000.csv", "rounding"),
        #(rounding, (1500, 12345678901234567890, 10000), "rounding_l_1500.csv"),
        (rounding_y, (2000, 12345678901234567890, 10000), "rounding_y_l_2000.csv", "rounding"),
        #(rounding, (2500, 12345678901234567890, 10000), "rounding_l_2500.csv"),
        (rounding_y, (3000, 12345678901234567890, 10000), "rounding_y_l_3000.csv", "rounding"),
        #(rounding, (3500, 12345678901234567890, 10000), "rounding_l_3500.csv"),
        (rounding_y, (4000, 12345678901234567890, 10000), "rounding_y_l_4000.csv", "rounding"),
        #(rounding, (4500, 12345678901234567890, 10000), "rounding_l_4500.csv"),
        ...
        (star_intersections_11, (1000, 10000), "star_intersections_11_s_1000.csv", "star_intersections"),
        # (star_intersections_11, (1500, 10000), "star_intersections_11_s_1500.csv"),
        (star_intersections_11, (2000, 10000), "star_intersections_11_s_2000.csv", "star_intersections"),
        # (star_intersections_11, (2500, 10000), "star_intersections_11_s_2500.csv"),
        (star_intersections_11, (3000, 10000), "star_intersections_11_s_3000.csv", "star_intersections"),
        # (star_intersections_11, (3500, 10000), "star_intersections_11_s_3500.csv"),
        (star_intersections_11, (4000, 10000), "star_intersections_11_s_4000.csv", "star_intersections"),
        # (star_intersections_11, (4500, 10000), "star_intersections_11_s_4500.csv"),
        (star_intersections_11, (5000, 10000), "star_intersections_11_s_5000.csv", "star_intersections"),
        # (star_intersections_11, (5500, 10000), "star_intersections_11_s_5500.csv"),
        # (star_intersections_11, (6000, 10000), "star_intersections_11_s_6000.csv"),
        # (star_intersections_11, (6500, 10000), "star_intersections_11_s_6500.csv"),
        # (star_intersections_11, (7000, 10000), "star_intersections_11_s_7000.csv"),
        # (star_intersections_11, (7500, 10000), "star_intersections_11_s_7500.csv"),
        # (star_intersections_11, (8000, 10000), "star_intersections_11_s_8000.csv"),
        # (star_intersections_11, (8500, 10000), "star_intersections_11_s_8500.csv"),
        # (star_intersections_11, (9000, 10000), "star_intersections_11_s_9000.csv"),
        # (star_intersections_11, (9500, 10000), "star_intersections_11_s_9500.csv"),
        # (star_intersections_11, (10000, 10000), "star_intersections_11_s_10000.csv"),

        # (star_intersections_11, (500, 1234567890), "star_intersections_11_m_500.csv"),
        (star_intersections_11, (1000, 1234567890), "star_intersections_11_m_1000.csv", "star_intersections"),
        # (star_intersections_11, (1500, 1234567890), "star_intersections_11_m_1500.csv"),
        (star_intersections_11, (2000, 1234567890), "star_intersections_11_m_2000.csv", "star_intersections"),
        # (star_intersections_11, (2500, 1234567890), "star_intersections_11_m_2500.csv"),
        (star_intersections_11, (3000, 1234567890), "star_intersections_11_m_3000.csv", "star_intersections"),
        # (star_intersections_11, (3500, 1234567890), "star_intersections_11_m_3500.csv"),
        (star_intersections_11, (4000, 1234567890), "star_intersections_11_m_4000.csv", "star_intersections"),
        # (star_intersections_11, (4500, 1234567890), "star_intersections_11_m_4500.csv"),
        (star_intersections_11, (5000, 1234567890), "star_intersections_11_m_5000.csv", "star_intersections"),
        # (star_intersections_11, (5500, 1234567890), "star_intersections_11_m_5500.csv"),
        # (star_intersections_11, (6000, 1234567890), "star_intersections_11_m_6000.csv"),
        # (star_intersections_11, (6500, 1234567890), "star_intersections_11_m_6500.csv"),
        # (star_intersections_11, (7000, 1234567890), "star_intersections_11_m_7000.csv"),
        # (star_intersections_11, (7500, 1234567890), "star_intersections_11_m_7500.csv"),
        # (star_intersections_11, (8000, 1234567890), "star_intersections_11_m_8000.csv"),
        # (star_intersections_11, (8500, 1234567890), "star_intersections_11_m_8500.csv"),
        # (star_intersections_11, (9000, 1234567890), "star_intersections_11_m_9000.csv"),
        # (star_intersections_11, (9500, 1234567890), "star_intersections_11_m_9500.csv"),
        # (star_intersections_11, (10000, 1234567890), "star_intersections_11_m_10000.csv"),

        # (star_intersections_11, (500, 12345678901234567890), "star_intersections_11_l_500.csv"),
        (star_intersections_11, (1000, 12345678901234567890), "star_intersections_11_l_1000.csv", "star_intersections"),
        # (star_intersections_11, (1500, 12345678901234567890), "star_intersections_11_l_1500.csv"),
        (star_intersections_11, (2000, 12345678901234567890), "star_intersections_11_l_2000.csv", "star_intersections"),
        # (star_intersections_11, (2500, 12345678901234567890), "star_intersections_11_l_2500.csv"),
        (star_intersections_11, (3000, 12345678901234567890), "star_intersections_11_l_3000.csv", "star_intersections"),
        # (star_intersections_11, (3500, 12345678901234567890), "star_intersections_11_l_3500.csv"),
        (star_intersections_11, (4000, 12345678901234567890), "star_intersections_11_l_4000.csv", "star_intersections"),
        # (star_intersections_11, (4500, 12345678901234567890), "star_intersections_11_l_4500.csv"),
        (star_intersections_11, (5000, 12345678901234567890), "star_intersections_11_l_5000.csv", "star_intersections"),
        # (star_intersections_11, (5500, 12345678901234567890), "star_intersections_11_l_5500.csv"),
        # (star_intersections_11, (6000, 12345678901234567890), "star_intersections_11_l_6000.csv"),
        # (star_intersections_11, (6500, 12345678901234567890), "star_intersections_11_l_6500.csv"),
        # (star_intersections_11, (7000, 12345678901234567890), "star_intersections_11_l_7000.csv"),
        # (star_intersections_11, (7500, 12345678901234567890), "star_intersections_11_l_7500.csv"),
        # (star_intersections_11, (8000, 12345678901234567890), "star_intersections_11_l_8000.csv"),
        # (star_intersections_11, (8500, 12345678901234567890), "star_intersections_11_l_8500.csv"),
        # (star_intersections_11, (9000, 12345678901234567890), "star_intersections_11_l_9000.csv"),
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=os.cpu_count()) as executor:
        futures = {executor.submit(process_configuration, func, params, filename, folder): (func, params, filename, folder) for func, params, filename, folder in configurations}
